          ...
          <div className="section-panel" style={{ padding: '1.8rem', borderRadius: '24px', marginBottom: 0 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              <div style={{ background: '#f9fafb', padding: '1.2rem', borderRadius: '16px', border: '1px solid #f3f4f6' }}>
                <div style={{ fontSize: '1.3rem', fontWeight: 800, marginBottom: '8px' }}>Rs. {((topProducts[0]?.total_revenue || 0) / 1000000).toFixed(1)}M</div>
                <div style={{ fontSize: '0.75rem', color: '#9ca3af', lineHeight: '1.4' }}>Generated by top product:<br/><span style={{ color: '#111827', fontWeight: 600 }}>{topProducts[0]?.product_name?.substring(0, 18)}...</span></div>
              </div>
              <div style={{ background: '#f9fafb', padding: '1.2rem', borderRadius: '16px', border: '1px solid #f3f4f6' }}>
                <div style={{ fontSize: '1.3rem', fontWeight: 800, marginBottom: '8px' }}>{categoryLevel[1]?.category_count?.toLocaleString() || 0} <span style={{ fontSize: '0.8rem', fontWeight: 500, opacity: 0.6 }}>Active</span></div>
                <div style={{ fontSize: '0.75rem', color: '#9ca3af', lineHeight: '1.4' }}>Sub-categories operating<br/>at Depth Level {categoryLevel[1]?.category_level || 1}</div>
              </div>
            </div>
          </div>
